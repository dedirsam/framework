                                ...
                                <div class="card-body">
                                    <div class="tab-content">
                                        <div class="tab-pane fade show active" id="tabs-eg-77">
                                            ...
                                            <h6 class="text-muted text-uppercase font-size-md opacity-5 fw-normal">Top Authors</h6>
                                ...
                                <div class="card-header-tab card-header">
                                    ...
                                    <div class="btn-actions-pane-right">
                                        <div class="nav">
                                            ...
                                            <a href="javascript:void(0);" class="ms-1 btn-pill btn-wide border-0 btn-transition  btn btn-outline-alternate second-tab-toggle-alt">Tab 2</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="tab-content">
                        ...
                        <div class="col-md-12">
                            <div class="main-card mb-3 card">
                                ...
                                <div class="d-block text-center card-footer">
                                    <button class="me-2 btn-icon btn-icon-only btn btn-outline-danger"><i class="pe-7s-trash btn-icon-wrapper"> </i></button>
